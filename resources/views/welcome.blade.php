...
<head>
    ...
    <style>
      body {
        ...
        .navbar-brand img {
            width: 20%; /* Ajuster la taille de l'image du logo si nécessaire */
            height: auto;
            border-radius: 50%
        }
        ...
        .navbar-nav .nav-link:hover {
            color: #000000 !important; /* Couleur de survol */
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
        <a class="navbar-brand" href="{{ Route('home') }}">
            <img src="https://th.bing.com/th/id/OIP.sEy1zeTvATSS41GslAWJ6QHaHa?w=196&h=196&c=7&r=0&o=5&dpr=1.3&pid=1.7" alt="logo">
        </a>
